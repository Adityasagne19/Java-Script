...
function validateGuess(guess) {
  if (isNaN(guess)) {
    ...
    alert('Please Enter an valid number greater then 1.');
  } else if (guess > 100) {
    alert('Please Enter an valid number smaller then 100.');
  }
...
function checkGuess(guess) {
  if (guess === randomNo) {
    ...
    displayMessage(`You Have Guessed It Wrong`);
  }
}
